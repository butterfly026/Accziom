...
import { useMyToast, request, ACZContent, PrimaryButton } from "@common";
...
export default function PageFooter() {
  ...
  return (
    <Flex
      ...
      p="3rem 1rem"
    >
      <ACZContent w={{ base: "100%", sm: "100%", md: "900px", lg: "1270px" }}>
        <Flex
            ...
            <Flex>
              <Flex sx={styles.FooterInput}>
                <Input
                  ...
                  variant="unstyled"
                  value={getEmail}
                  placeholder={intl.formatMessage({id: 'text.EmailAddress'})}
                  onChange={(e: any) => {
