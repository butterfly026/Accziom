...
const sidebars = [
  ...
  },
  {
    ...
    children: [
      ...
      //       icon: '',
      //       seicon: '',
      //       url: '/home/luckybox/ninebox',
      //     },
      //     {
      //       label: 'SpinLottery',
      //       icon: '',
      //       seicon: '',
      //       url: '/home/luckybox/spinlottery',
      //     }
      //   ]
      // },
      {
          ...
          <Flex mx={5} mb={7} pb={5} flexDir='column' sx={styles.SUserInfo}>
            ...
            <Flex flexDir='column' px={2} pt={2}>
              ...
              <Text
                ...
                sx={{ _dark: { color: '#fff' } }}
              >
                {formatMoney(user?.balance_staking)}
              </Text>
            </Flex>
                          ...
                          {res?.children?.map((json: any, idx: number) => {
                            return (
                              <>
                                ...
                                <ul>
                                  {
                                    json.children?.map((child: any, idx2: number) => {
                                      return <li
                                        style={{ listStyle: 'none', marginLeft: '20px' }}
                                        className='sidebar_list'
                                        key={`sidebar_f_${index}_${idx}_${idx2}`}
                                        onClick={() => setShowS(false)}
                                      >
                                        <SideNavFButton
                                          title={intl.formatMessage({
                                            id: 'home.sidebar.' + child?.label,
                                          })}
                                          link={child.url}
                                          icon={
